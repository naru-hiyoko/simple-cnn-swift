...
func batch_normalization(_in : [Float], _in_dimension : [Int], E : [Float], V : [Float], scale : [Float], 
    gamma : Float = 1.0, beta : Float = 0.0)-> [Float]
{
    ...
    var result : [Float] = [Float](count: num_output * height * width, repeatedValue: 0.0)
